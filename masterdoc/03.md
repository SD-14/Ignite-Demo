...
7. Return to the Azure Portal session.
...
13.	Expand the **ignitekustopool** Data Explorer pool.
...
19. In the Database dropdown, select **IngiteDB**. Then in the **Table** textbox, enter/type **Thermostat**.
...
25.	In **Data connection name** dropdown list, select **IgniteDB-thermostat**.
...
39. In the **Use database** dropdown list, select **IgniteDB**.
