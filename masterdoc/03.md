...
![Click Next](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/img119.png?raw=true)
 ...
 > ❗ **Note:** In Step 18 if you do NOT see any Azure Data Explorer Pool in **Cluster** dropdown, select **Add Cluster** then follow steps a-f below. If you do see ADX Cluster in dropdown, then continue to step 21.
