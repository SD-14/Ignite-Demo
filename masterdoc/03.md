...
18.	In the **Destination** tab, in **Cluster** dropdown list, select the Data Explorer pool starting with **analyticskustopool-**.
...
38. In the **Connect to** dropdown list, select the data explorer pool starting with **analyticskustopool-**.
