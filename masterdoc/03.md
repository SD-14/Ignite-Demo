...
6. Select **Browse** (on the top left )
...
7. Return to the Azure Portal session by selecting the resource group from the top breadcrumbs navigation bar.

![Return to Azure Portal](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/returnToAzurePortal.png?raw=true)
...
13.	Expand the **analyticskustopool** Data Explorer pool.
...
![Expand Data Explorer Pool](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image1118.png?raw=true)

15. Select **Open in Azure Data Explorer**.

*This will open Azure Data Explorer in a new web session (tab).*

![Open Azure Data Explorer](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/imageOpenADX.png?raw=true)
...
18.	In the **Destination** tab, in **Cluster** dropdown list, select the Data Explorer pool.
     
19. In the Database dropdown, select **AnalyticsDB**. Then in the **Table** textbox, enter/type **Thermostat**.

![Click Next](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image1131.png?raw=true)
...
c. Select the **analyticsKustopool-**.

![manage tab](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/imageManageHub.png?raw=true)

d. Under the **Query endpoint** copy the **URL** and select **Close** to close the pane.

![Copy URI](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/imageCopyURI.png?raw=true)
...
![click Add](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/imageClickAdd.png?raw=true)
...
![Select Eventhub](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/imageSelectEventhub.png?raw=true)
...
![Click Next](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image1139.png?raw=true)
...
![Click Next](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image1143.png?raw=true)
...
![Select Close](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image1144.png?raw=true)
...
38. In the **Connect to** dropdown list, select the data explorer pool.
...
![Review the query result ](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image1152.png?raw=true)

*Your graph may appear slightly different than the one shown above. It may take up to 60 seconds to load.*

43.	Notice that the temperature in the Miami store is oscillating between 65 and 70 degrees Fahrenheit. Also notice, that as soon as any unanticipated spike occurs in the store temperature, it is automatically cooled down using ADX.
