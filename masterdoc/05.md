...
9.	In the **Open** window, navigate to the **C:\LabFiles\artifacts\reports** folder, and then select the **AnalyticsDemoReport.pbix** file.
...
12.	To open the report, select the **AnalyticsDemoReport**.
...
19. Select **Website Analytics** from the top right pane to navigate to the Website Analytics Report.
...
22. Select **Top Segments** to show the details.
