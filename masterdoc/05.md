...
![Architecture Diagram](/../main/media/images/image3100.png)
...
![Select the persona](/../main/media/images/image3101.png)
...
![Select the workspaces](/../main/media/images/image3102.png)
...
3. Review the **cmd 11** cell, and then review the output for **Exploratory Data Analysis**.
   ...
   ![cmd 11](/../main/media/images/image3103.png)

4. Review the **cmd 29** cell.

By analyzing Customer Churn data, we create multiple Machine Learning models.

![Runs using a parallel coordinates](/../main/media/images/image3115.png)
...
![Load Azure ML workspace](/../main/media/images/image3119.png)
...
6. In the left, select the small arrow to expand the sidebar, collapse the **Customer Churn Model** and select **Twitter Sentiment Score Model**.
   ...
   ![Twitter sentiment score model](/../main/media/images/image3123.png)
...
*Here the Twitter sentiment model is trained for further consumption.*
   ...
   ![Customer model train and validation](/../main/media/images/image3126.png)
...
8. From the sidebar, select **Campaign Analytics**.
   ...
   ![Campaign Analytics](/../main/media/images/image3128.png)
...
![cmd 88](/../main/media/images/image3129.png)

**Sales Forecasting**

10. From the sidebar, select **Sales Forecasting**.

    ![Sales Forecasting](/../main/media/images/image3132.png)
...
11. Review the **cmd 127** cell where model deployment is created.
    ...
    ![Model Deployement](/../main/media/images/image3136.png)
...
12. Review the **cmd 133** cell to see sales forecast using store data after launching the campaigns.
    ...
    ![Store data after the campaigns ](/../main/media/images/image3138.png)
...
![Register on Power BI](/../main/media/images/image3202.png)
...
![Enter a dummy number](/../main/media/images/imageDummyNumber.png)


4.	If prompted, select **Get Started**.

![Get Started with Power BI](/../main/media/images/image3203.png)
...
![Select New Workspace](/../main/media/images/imageMyWorkspace.png)

7. To upload a Power BI Desktop file, on the **New** dropdown menu, select **Upload a file**.

> **Note:** Please make sure you are **logged into the VM** for the following steps.

![Select upload](/../main/media/images/image3208.png)

8.	Select the **Local File** tile.

![Select upload](/../main/media/images/image3209.png)
...
![Upload report upload](/../main/media/images/imageFilePath.png)
...
![Power BI report added to your workspace.](/../main/media/images/image3212.png)
...
![PowerBI Report Name](/../main/media/images/image3227.png)
...
![PowerBI Report Buttons](/../main/media/images/image3228.png)
...
![Scatter chart](/../main/media/images/image3229.png)
...
![Select Campaigns Analytics](/../main/media/images/image3238.png)
...
![Campaigns report - Bar chart](/../main/media/images/image3239.png)


19. Click on **Website Analytics** from the top right pane to navigate to the Website Analytics Report.

![Website Analytics](/../main/media/images/imageWebsiteAnalytics.png)
...
![Site visitors by age group](/../main/media/images/imageAgeGroup.png) 

![Repeat customers](/../main/media/images/imageSurfingBoard.png)
...
![Repeat Customers Chart](/../main/media/images/imageRepeatCustomersGraph.png)
...
![Key influencers Chart](/../main/media/PowerBI-Images/websiteAnalytics-keyInfluencers.png)
...
![Top Segments](/../main/media/images/image3248.png)
...
![Millenials using mobile phone](/../main/media/images/imagePowerBI.png)
...
![Select Azure Synapse Analytics](/../main/media/images/image3302.png)

3.	In the filtered results, select the Azure Synapse resource.

![Select Azure Synapse resource](/../main/media/images/image3303.png)
...
![Open Synapse studio](/../main/media/images/image3304.png)
...
![Query Campaign And Twitter Data Using TSQL Language](/../main/media/images/image3307.png)
...
![Select Run](/../main/media/images/image3311.png)
...
![Select Run](/../main/media/images/image3314.png)
...
![Select Azure Databricks](/../main/media/images/image3402.png)
...
![Select Azure Databricks resource](/../main/media/images/image3403.png)

4. In the Azure Databricks resource page, select **Launch Workspace**.

![Select Azure Databricks resource](/../main/media/images/image2104.png)
...
![Go to 04_SQL_Analytics_On_Delta_Live_Tables](/../main/media/images/image3405.png)
...
![Raw Twitter data](/../main/media/images/image3406.png)
...
![Filtered Twitter data](/../main/media/images/image3407.png)
...
![Curated Twitter data](/../main/media/images/image3408.png)
...
![Aggregations Are A Great User Experience Enhancement](/../main/media/images/image3410.png)
...
![Z-Order Optimization](/../main/media/images/image3411.png)
...
![Caching](/../main/media/images/image3412.png)
...
![Time Travel](/../main/media/images/image3413.png)
