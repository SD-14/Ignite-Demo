...
6. In the left, select the small arrow to expand the sidebar, collapse the **Customer Churn Model** and select **Twitter Sentiment Score Model**.
   ...
   ![Twitter sentiment score model](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3123.png?raw=true)
...
![Register on Power BI](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3202.png?raw=true)
...
![Enter a dummy number](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/imageDummyNumber.png?raw=true)


4.	If prompted, select **Get Started**.

![Get Started with Power BI](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3203.png?raw=true)
...
9.	In the **Open** window, navigate to the **C:\LabFiles\artifacts\reports** folder, and then select the **IgniteDemoReport.pbix** file.
...
![PowerBI Report Buttons](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3228.png?raw=true)
...
The **site visitors by age group** chart shows that most of the "Not Happy" Customers are in the  age group of 31 to 40. It seems that millennials make up the majority of unhappy online customers. Now, let us see what these millenials typically shop for online.
...
![Select Azure Synapse Analytics](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3302.png?raw=true)
...
![Select Run](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3311.png?raw=true)
...
![Select Azure Databricks resource](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3403.png?raw=true)
